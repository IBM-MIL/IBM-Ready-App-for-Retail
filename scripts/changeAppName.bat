...
REM  © Copyright IBM Corporation 2014. All Rights Reserved.
REM  This sample program is provided AS IS and may be used, executed, copied and modified without
REM  royalty payment by customer (a) for its own instruction and study, (b) in order to develop
REM  applications designed to run with an IBM product, either for customer's own internal use or for
REM  redistribution by customer, as part of such an application, in customer's own products.
REM  
REM ################################################################################################
REM 
